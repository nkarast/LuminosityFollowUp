...
class LumiFollowUp(object):
    ...
    def checkFiles(self, filln):
        ...
        return getMassi, skipMassi, doSB, doSBFits, doSBModel, doLifetime, doLumiCalc, doCycle, doCycle_model, skip
    ## - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - * - - *
    ...
    def makePerformancePlotsPerFill(self, filln, doIntLifetime, doLumiTau):     ## @TODO have not checked that yet
        ...
        if self.savePlots:
            ...
            if not self.skipMassi:
                figDic.update({     fig_lumi_meas   :'fill_{}_measLumi_{}'.format(filln, saveString),
    ...
    def runForFill(self, filln):
        ...
        getMassi, self.skipMassi, doSB, doSBFits, doSBModel, doLifetime, doLumiCalc, doCycle, doCycle_model, skip = self.checkFiles(filln)
        print '---->', getMassi, self.skipMassi, doSB, doSBFits, doSBModel, doLifetime, doLumiCalc, doCycle, doCycle_model, skip
        ...
        if getMassi and not self.skipMassi:
